...
Rectangle {
    ...
    Item {
        ...
        SequentialAnimation {
            ...
            PropertyAction { target: myRot; property: "origin.x"; value: Kirigami.Units.gridUnit * 1.185 }
            PropertyAction { target: myRot; property: "origin.y"; value: Kirigami.Units.gridUnit * 1.185 }
        ...
        Rectangle {
            ...
            anchors.leftMargin: Kirigami.Units.gridUnit * 0.2
            color: "#00000000"
            radius: 1000
